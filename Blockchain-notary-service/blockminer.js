...
class BlockMiner{
    ...
    mineBlock(memorypool,bodycontent){
        ...
        return new Promise((resolve, reject) => {
            ...
            dataAccess.getBlockchainHeight()
            .then(height => {
                ...
                if (height === -1){
                  ...
                  dataAccess.getBlockchainHeight().then(height => {
                        if (height === -1) {
                          ...
                          dataAccess.addBlock(genesysBlock.height, JSON.stringify(genesysBlock)).then(() => {
                    ...
                    dataAccess.getBlockByHeigth(height).then(value => {
                        ...
                        dataAccess.addBlock(this.block.height, JSON.stringify(this.block)).then(() => {
                            var heightValue= this.block.height;
                            resolve(heightValue);
                          });   
